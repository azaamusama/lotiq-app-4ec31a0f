...
const SIGNALS = [
  ...
  { icon: Star, label: "20K+ Products", detail: "Curated top brands" },
  ...
  return (
    <section className="py-6 lg:py-8 bg-card">
      <div className="container">
        <h2 className="text-lg font-semibold text-foreground mb-4 text-center">Why Dental Professionals Choose Safco</h2>
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          {SIGNALS.map(({ icon: Icon, label, detail }) => (
            <div key={label} className="flex flex-col items-center text-center p-4">
              <div className="w-10 h-10 rounded-full bg-bg-green flex items-center justify-center mb-2">
