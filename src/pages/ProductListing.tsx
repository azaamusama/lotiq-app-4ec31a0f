...
const PLPProductCard = ({
  ...
  <div className="bg-card border border-border rounded-lg overflow-hidden flex flex-col group hover:shadow-md transition-shadow">
    ...
    <div className="relative bg-white">
      ...
      {lastPurchased && (
        <div className="absolute top-2 left-2 bg-card border border-border/80 text-[10px] text-foreground px-2 py-1 rounded font-semibold shadow-sm backdrop-blur-sm">
